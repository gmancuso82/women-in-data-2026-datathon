...
- Enter a market quantity or choose a quantity preset to scale the selected per-kilogram price difference into a potential gross price difference.
...
- The quantity estimate is price-only: it excludes availability, yields, transport, contracts, waste, and dietary planning.
