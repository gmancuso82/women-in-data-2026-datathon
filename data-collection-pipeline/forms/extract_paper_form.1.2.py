...
Usage (unchanged):
    python3 extract_paper_form.1.2.py <pdf_path> <fieldmap.json> <schema.json> <output_basename>
    python3 extract_paper_form.1.2.py --batch <folder_of_pdfs> <fieldmap.json> <schema.json> <output_basename>
    python3 extract_paper_form.1.2.py --review <pdf_path> <fieldmap.json> <schema.json> <out_dir>
    python3 extract_paper_form.1.2.py --ingest <corrected_manifest.csv> <labels_dir>
"""
