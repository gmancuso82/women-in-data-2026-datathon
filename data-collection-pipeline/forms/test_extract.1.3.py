"""
Verification harness for extract_paper_form.1.2.py's new star-mark detector
...
spec = importlib.util.spec_from_file_location("extract_paper_form", "extract_paper_form.1.2.py")
