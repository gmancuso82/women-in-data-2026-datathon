...
with open("hoos_cooking_paper_form_NGA.1.1_fieldmap.json") as f:
    fieldmap = json.load(f)
with open("hoos_cooking_form_schema.1.2.json") as f:
    schema = json.load(f)

images = pdf_to_page_images("hoos_cooking_paper_form_NGA.1.1.pdf")
...
for i, img in enumerate(images):
    img.save(f"synthetic_star_page_{i+1}.png")
